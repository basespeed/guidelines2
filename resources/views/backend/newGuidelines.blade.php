...
<div class="fullpage_fix">
    <div class="sidebar menu_admin">
        <div class="logo">
            ...
            <input type="file" data-id="{{$id_logo}}" class="upload_logo" name="upload_logo_menu"/>
        </div>
        {{--<h3>Client info</h3>--}}
        <br/>
        ...
        <div class="copyright_menu">
            <button class="btn_save" type="submit" name="save_new_guide" value="true">Save Guidelines</button>
    ...
    <div id="fullpage" class="fullpage_admin fullpage_new">
        <section class="section section1" style="background: #b9b9b9;">
            <button class="btn_ground" type="button">
                ...
                <input type="file" data-id="{{$id_background_layout1}}" data-menu="{{$id_menu1}}" name="section1_upload_background" class="upload_background section1_upload_background"/>
            </button>
        ...
        <section class="section section3" style="background: #b9b9b9;">
            <button class="btn_ground" type="button">
                <img src="images/upload2.png" alt="icon" />
                <span>Upload background</span>
                <input type="file" data-id="{{$id_background_layout3}}" data-menu="{{$id_menu3}}" name="section3_upload_background" class="upload_background section3_upload_background"/>
            </button>
            <div class="intro">
                    ...
                    <div class="item">
                        <div class="insider">
                            <button class="btn_ground1" type="button">
                                ...
                                <input type="file" data-id="{{$id_logo1_layout4}}" data-menu="{{$id_menu4}}" name="section4_upload_background1" class="upload_background section4_upload_background1"/>
                                <i class="fa fa-times" aria-hidden="true"></i>
                            </button>
                            <h3>Logo định dạng ngang</h3>

                            <button class="btn_input" type="button">
                                <input type="file" data-id="{{$id_vector1_layout4}}" data-menu="{{$id_menu4}}" name="section4_file_vector1" class="upload_filelogo file_vector1 section4_file_vector1"/>
                                <span>Upload file vector</span>
                            </button>

                            <button class="btn_input" type="button">
                                <input type="file" data-id="{{$id_zip_img1}}" data-menu="{{$id_menu4}}" name="section4_file_img1" class="upload_filelogo file_img1 section4_file_img1"/>
                    ...
                    <div class="item">
                        <div class="insider">
                            <button class="btn_ground2" type="button">
                                <img src="images/editlogo.png" alt="icon" />
                                <input type="file" data-id="{{$id_logo2_layout4}}" data-menu="{{$id_menu4}}" name="section4_upload_background2" class="upload_background section4_upload_background2"/>
                                <i class="fa fa-times" aria-hidden="true"></i>
                            </button>
                            <h3>Logo định dạng ngang</h3>

                            <button class="btn_input" type="button">
                                <input type="file" data-id="{{$id_vector2_layout4}}" data-menu="{{$id_menu4}}" name="section4_file_vector2" class="upload_filelogo file_vector2 section4_file_vector2"/>
                                <span>Upload file vector</span>
                            </button>

                            <button class="btn_input" type="button">
                                <input type="file" data-id="{{$id_zip_img2_layout4}}" data-menu="{{$id_menu4}}" name="section4_file_img2" class="upload_filelogo file_img2 section4_file_img2"/>
                                <span>Upload hình ảnh</span>
                            </button>
                        </div>
                    </div>
        ...
        <section class="section section5">
            <div class="in">
                ...
                <button class="btn_ground_idea" type="button">
                    ...
                    <input type="file" data-id="{{$id_logo_layout5}}" data-menu="{{$id_menu5}}" name="section5_upload_background2" class="upload_background section5_upload_background2"/>
                    <i class="fa fa-times" aria-hidden="true"></i>
                </button>

                <textarea class="text_idea section5_text" data-id="{{$id_info5}}" data-menu="{{$id_menu5}}" name="section5_text" placeholder="Nội dung"></textarea>
            </div>
        </section>
                ...
                <div class="list_logo">
                    ...
                    <div class="item">
                        <button class="btn_ground_size" type="button">
                            <img src="images/upto4.png" alt="icon" />
                            <input type="file" data-id="{{$id_logo_layout6}}" data-menu="{{$id_menu6}}" name="section6_upload_background2" class="upload_background section6_upload_background2"/>
                            <i class="fa fa-times" aria-hidden="true"></i>
                        </button>
                    </div>
                </div>
            ...
            <div class="in">
                ...
                <div class="list_color">
                    ...
                    <div class="item">
                        <div class="content">
                            <div class="list_color">
                                <div class="edit_color"><input type="text" data-id="{{$id_color1_layout7}}" data-menu="{{$id_menu7}}" class="cp-full1 section7_color1" value="" name="section7_color1" placeholder="Nhập mã màu" style="width:350px" /></div>
                                <div class="list">
                            ...
                            <div class="list_color list_color2">
                                <div class="edit_color"><input type="text" data-id="{{$id_color2_layout7}}" data-menu="{{$id_menu7}}" class="cp-full2 section7_color2" name="section7_color2" placeholder="Nhập mã màu"/></div>
                                <div class="list">
                        ...
                        <div class="content">
                            <div class="list_color">
                                <div class="get_input_gradient1">
                                    <div class="input">
                                        <input type="text" data-id="{{$insert_color1}}" data-menu="{{$id_menu8}}" name="section8_ga1" class="ga1 section8_ga1" placeholder="Nhập mã màu" />
                                    </div>
                                    <div class="input">
                                        <span>+</span>
                                    </div>
                                    <div class="input">
                                        <input type="text" data-id="{{$insert_color1}}" data-menu="{{$id_menu8}}" name="section8_ga2" class="ga2 section8_ga1" placeholder="Nhập mã màu" />
                                    </div>
                                </div>
                                <div class="list">
                            ...
                            <div class="list_color">
                                <div class="get_input_gradient2">
                                    <div class="input">
                                        <input type="text" data-id="{{$insert_color2}}" data-menu="{{$id_menu8}}" name="section8_ga3" class="ga3 section8_ga3" placeholder="Nhập mã màu" />
                                    </div>
                                    <div class="input">
                                        <span>+</span>
                                    </div>
                                    <div class="input">
                                        <input type="text" data-id="{{$insert_color2}}" data-menu="{{$id_menu8}}" name="section8_ga4" class="ga4 section8_ga4" placeholder="Nhập mã màu" />
                                    </div>
                                </div>
                                <div class="list">
                        ...
                        <div class="content">
                            ...
                            <div class="btn_front">
                                <div class="button">
                                    ...
                                    <input type="file" data-id="{{$id_font1_layout9}}" data-menu="{{$id_menu9}}" name="section9_upload_font_th" class="upload_font_th section9_upload_font_th"/>
                                </div>
                                <div class="button">
                                    <span>Upload font bổ trợ</span>
                                    <input type="file" data-id="{{$id_font2_layout9}}" data-menu="{{$id_menu9}}" name="section9_upload_font_bt" class="upload_font_bt section9_upload_font_bt"/>
                                </div>
                                <div class="button">
                                    <span>Upload font văn bản</span>
                                    <input type="file" data-id="{{$id_font3_layout9}}" data-menu="{{$id_menu9}}" name="section9_upload_font_vb" class="upload_font_vb section9_upload_font_vb"/>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="in">
                ...
                <div class="list_logo">
                    ...
                    <div class="item">
                        <button class="btn_ground_size" type="button">
                            <img src="images/upto4.png" alt="icon" />
                            <input type="file" data-id="{{$id_logo_layout10}}" data-menu="{{$id_menu10}}" name="section10_upload_background2" class="upload_background section10_upload_background2"/>
                            <i class="fa fa-times" aria-hidden="true"></i>
                        </button>
                    </div>
                </div>
                        ...
                        <div class="content">
                            <div class="list">
                                <button class="btn_ground_logo" type="button">
                                    <img src="images/upto4.png" alt="icon" />
                                    <input type="file" data-id="{{$id_logo1_layout11}}" data-menu="{{$id_menu11}}" name="section11_upload_background2" class="upload_background section11_upload_background2" alt="logo"/>
                                    <i class="fa fa-times" aria-hidden="true"></i>
                                </button>
                            ...
                            <div class="list">
                                <button class="btn_ground_logo" type="button">
                                    <img src="images/upto4.png" alt="icon" />
                                    <input type="file" data-id="{{$id_logo2_layout11}}" data-menu="{{$id_menu11}}" name="section11_upload_background22" class="upload_background section11_upload_background22" alt="logo"/>
                                    <i class="fa fa-times" aria-hidden="true"></i>
                                </button>
                    ...
                    <div class="item">
                        <div class="content">
                            <div class="list_g">
                                <button class="btn_ground_logo" type="button">
                                    <img src="images/upto4.png" alt="icon" />
                                    <input type="file" data-id="{{$id_logo1_layout12}}" data-menu="{{$id_menu12}}" name="section12_upload_background2" class="upload_background section12_upload_background2" alt="logo"/>
                                    <i class="fa fa-times" aria-hidden="true"></i>
                                </button>
                            ...
                            <div class="list_g">
                                <button class="btn_ground_logo" type="button">
                                    <img src="images/upto4.png" alt="icon" />
                                    <input type="file" data-id="{{$id_logo2_layout12}}" data-menu="{{$id_menu12}}" name="section12_upload_background22" class="upload_background section12_upload_background22" alt="logo"/>
                                    <i class="fa fa-times" aria-hidden="true"></i>
                                </button>
                            ...
                            <div class="item">
                                <div class="insider">
                                    ...
                                    <div class="btn_front btn_front_edit">
                                        <div class="button">
                                            <span>Upload file vector</span>
                                            <input type="file" data-id="{{$id_vector1_layout13}}" data-menu="{{$id_menu13}}" name="section13_upload_vector" class="upload_vector section13_upload_vector"/>
                                        </div>
                                        <div class="button">
                                            <span>Upload hình ảnh</span>
                                            <input type="file" data-id="{{$id_image1_layout13}}" data-menu="{{$id_menu13}}" name="section13_upload_img" class="upload_img section13_upload_img"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="insider">
                                    ...
                                    <div class="btn_front btn_front_edit">
                                        <div class="button">
                                            <span>Upload file vector</span>
                                            <input type="file" data-id="{{$id_vector2_layout13}}" data-menu="{{$id_menu13}}" name="section13_upload_vector2" class="upload_vector section13_upload_vector2"/>
                                        </div>
                                        <div class="button">
                                            <span>Upload hình ảnh</span>
                                            <input type="file" data-id="{{$id_image2_layout13}}" data-menu="{{$id_menu13}}" name="section13_upload_img2" class="upload_img section13_upload_img2"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="insider">
                                    ...
                                    <div class="btn_front btn_front_edit">
                                        <div class="button">
                                            <span>Upload file vector</span>
                                            <input type="file" data-id="{{$id_vector3_layout13}}" data-menu="{{$id_menu13}}" name="section13_upload_vector3" class="upload_vector section13_upload_vector3"/>
                                        </div>
                                        <div class="button">
                                            <span>Upload hình ảnh</span>
                                            <input type="file" data-id="{{$id_image3_layout13}}" data-menu="{{$id_menu13}}" name="section13_upload_img3" class="upload_img section13_upload_img3"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="insider">
                                    ...
                                    <div class="btn_front btn_front_edit">
                                        <div class="button">
                                            <span>Upload file vector</span>
                                            <input type="file" data-id="{{$id_vector4_layout13}}" data-menu="{{$id_menu13}}" name="section13_upload_vector4" class="upload_vector section13_upload_vector4"/>
                                        </div>
                                        <div class="button">
                                            <span>Upload hình ảnh</span>
                                            <input type="file" data-id="{{$id_image4_layout13}}" data-menu="{{$id_menu13}}" name="section13_upload_img4" class="upload_img section13_upload_img4"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="item">
                        <div class="content">
                            <div class="list">
                                <button class="btn_ground_size" type="button">
                                    <img src="images/upto4.png" alt="icon" />
                                    <input type="file" data-id="{{$id_logo_layout14}}" data-menu="{{$id_menu14}}" name="section14_upload_background2" class="upload_background section14_upload_background2"/>
                                    <i class="fa fa-times" aria-hidden="true"></i>
                                </button>
                            </div>
                        </div>
                                ...
                                <div class="item">
                                    <div class="insider">
                                        <div class="logo">
                                            <button class="btn_ground_logo" type="button">
                                                <img src="images/upto4.png" alt="icon" />
                                                <input type="file" data-id="{{$id_logo1_layout15}}" data-menu="{{$id_menu15}}" name="section15_upload_background1" class="upload_background section15_upload_background1" alt="logo"/>
                                                <i class="fa fa-times" aria-hidden="true"></i>
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="item">
                                    <div class="insider">
                                        <div class="logo">
                                            <button class="btn_ground_logo" type="button">
                                                <img src="images/upto4.png" alt="icon" />
                                                <input type="file" data-id="{{$id_logo2_layout15}}" data-menu="{{$id_menu15}}" name="section15_upload_background2" class="upload_background section15_upload_background2" alt="logo"/>
                                                <i class="fa fa-times" aria-hidden="true"></i>
                                            </button>
                                        </div>
                                ...
                                <div class="item">
                                    <div class="insider">
                                        <div class="logo">
                                            <button class="btn_ground_logo" type="button">
                                                <img src="images/upto4.png" alt="icon" />
                                                <input type="file" data-id="{{$id_logo3_layout15}}" data-menu="{{$id_menu15}}" name="section15_upload_background3" class="upload_background section15_upload_background3" alt="logo"/>
                                                <i class="fa fa-times" aria-hidden="true"></i>
                                            </button>
                                        </div>
                ...
                <div class="list_color">
                    ...
                    <div class="item">
                        <div class="content">
                            <button class="btn_ground_logo" type="button">
                                <img src="images/upto4.png" alt="icon" />
                                <input type="file" data-id="{{$id_logo_layout16}}" data-menu="{{$id_menu16}}" name="section16_upload_background1" class="upload_background section16_upload_background1" alt="logo"/>
                                <i class="fa fa-times" aria-hidden="true"></i>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="item">
                        <div class="content">
                            <div class="list">
                                <button class="btn_ground_logo" type="button">
                                    <img src="images/upto4.png" alt="icon" />
                                    <input type="file" data-id="{{$id_logo_layout17}}" data-menu="{{$id_menu17}}" name="section17_upload_background2" class="upload_background section17_upload_background2" alt="logo"/>
                                    <i class="fa fa-times" aria-hidden="true"></i>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        ...
                        <div class="btn_front btn_front_edit">
                            <div class="button">
                                ...
                                <input type="file" data-id="{{$id_zip_layout18}}" data-menu="{{$id_menu18}}" name="section18_upload_img" class="upload_img section18_upload_img"/>
                            </div>
                        </div>
                    </div>
                    <div class="item">
                            ...
                            <div class="insider">
                                <div class="item">
                                    <div class="in">
                                        <button class="btn_ground_logo" type="button">
                                            <img src="images/upto4.png" alt="icon" />
                                            <input type="file" data-id="{{$id_img1_layout18}}" data-menu="{{$id_menu18}}" name="section18_upload_background1" class="upload_background section18_upload_background1" alt="logo"/>
                                            <i class="fa fa-times" aria-hidden="true"></i>
                                        </button>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="in">
                                        <button class="btn_ground_logo" type="button">
                                            <img src="images/upto4.png" alt="icon" />
                                            <input type="file" data-id="{{$id_img2_layout18}}" data-menu="{{$id_menu18}}" name="section18_upload_background2" class="upload_background section18_upload_background2" alt="logo"/>
                                            <i class="fa fa-times" aria-hidden="true"></i>
                                        </button>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="in">
                                        <button class="btn_ground_logo" type="button">
                                            <img src="images/upto4.png" alt="icon" />
                                            <input type="file" data-id="{{$id_img3_layout18}}" data-menu="{{$id_menu18}}" name="section18_upload_background3" class="upload_background section18_upload_background3" alt="logo"/>
                                            <i class="fa fa-times" aria-hidden="true"></i>
                                        </button>
                                    </div>
                                </div>
                                <div class="item">
                                    <div class="in">
                                        <button class="btn_ground_logo" type="button">
                                            <img src="images/upto4.png" alt="icon" />
                                            <input type="file" data-id="{{$id_img4_layout18}}" data-menu="{{$id_menu18}}" name="section18_upload_background4" class="upload_background section18_upload_background4" alt="logo"/>
                                            <i class="fa fa-times" aria-hidden="true"></i>
                                        </button>
                                    </div>
                                </div>

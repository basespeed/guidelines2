        ...
        <div id="fullpage" class="fullpage_admin fullpage_new">
            ...
            <section class="section section5">
                <div class="in">
                    ...
                    <textarea class="text_idea section5_text" name="section5_text" placeholder="Nội dung" style="text-align: left;">@foreach($data_info as $data)@if(!empty($data->content_info)){{$data->content_info}}@endif  @endforeach</textarea>
                                ...
                                @foreach($data_color as $color)
                                    @if($color->layout_color == 7)
                                        ...
                                        <div class="list_color list_color{{$count1}}">
                                            <div class="edit_color"><input type="text" class="cp-full{{$count1}} section7_color{{$count1}}" value="{{$color->hex}}" name="section7_color1" placeholder="Nhập mã màu" style="width:350px" /></div>
                                            @if(isset($color->rgb))
                                                @php
                                                    $rgb = $color->rgb;
                                                    $rgb = str_replace(' ', ',', $rgb)
                                ...
                                @foreach($data_color as $color)
                                    @if($color->layout_color == 8)
                                        @php
                                            $a++;
                                        @endphp
                                        <input type="hidden" name="insert_color{{$a}}" class="insert_color{{$a}}" value="{{$color->id_color}}">
                                        <div class="list_color">
                                            <div class="get_input_gradient1">
                                                <div class="input">
                                                    <input type="text" name="section8_ga{{$a}}" class="ga{{$a}} section8_ga{{$a}}" value="{{$color->hex}}" placeholder="Nhập mã màu" />
                                                </div>
                                                <div class="input">
                                                    <span>+</span>
                                                </div>
                                                <div class="input">
                                                    <input type="text" name="section8_ga{{$a+1}}" class="ga{{$a+1}} section8_ga{{$a}}" value="{{$color->hex2}}" placeholder="Nhập mã màu" />
                                                </div>
                                            </div>
                                            <div class="list">
                                                @if(isset($color->hex) && isset($color->hex2))
                                                    <div class="color_item get_gar{{$a}}" style="background-image: linear-gradient(to right, {{$color->hex}}, {{$color->hex2}});"></div>
                                                @else
                                                    <div class="color_item get_gar{{$a}}" style="background-image: linear-gradient(to right, #7b400a, #f67f13);"></div>
                                                @endif
                                            </div>
                                            <div class="info">
                                                <ul>
                            ...
                            <div class="content">
                                @foreach($data_image as $data)
                                    @if($data->image_type == 1 && $data->layout_image == 17)
                                        ...
                                        @endif
                                            <input type="hidden" class="id_logo_layout17" name="id_logo_layout17" value="{{$data->id_image}}" />
                                    @endif
                                @endforeach
                            </div>
                        </div>

...
<div class="fullpage_fix">
    <div class="sidebar menu_admin">
        ...
        <ul class="nav">
            <li data-id="3" class="active"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec3')}}">Logo guidelines</a> </i>
                <ul style="display: block">
                    <li data-id="4" data-menuanchor="sec4"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec4')}}">Logo</a></li>
                    <li data-id="5" data-menuanchor="sec5"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec5')}}">Ý nghĩa logo</a></li>
                    <li data-id="6" data-menuanchor="sec6"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec6')}}">Tỷ lệ đồ họa</a></li>
                    <li data-id="7" data-menuanchor="sec7"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec7')}}">Màu sắc</a></li>
                    <li data-id="8" data-menuanchor="sec8"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec8')}}">Màu hạn chế</a></li>
                    <li data-id="9" data-menuanchor="sec9"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec9')}}">Dải màu hỗ trợ</a></li>
                    <li data-id="10" data-menuanchor="sec10"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec10')}}">Font chữ sử dụng</a></li>
                    <li data-id="11" data-menuanchor="sec11"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec11')}}">Không gian trống tối thiểu</a></li>
                    <li data-id="12" data-menuanchor="sec12"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec12')}}">Các dạng thức sử dụng logo</a></li>
                    <li data-id="13" data-menuanchor="sec13"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec13')}}">Kích thước logo tối thiểu</a></li>
                    <li data-id="14" data-menuanchor="sec14"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec14')}}">Thi công dạng nổi, dạng chìm</a></li>
                    <li data-id="15" data-menuanchor="sec15"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec15')}}">Đặt trên nền ảnh</a></li>
                    <li data-id="16" data-menuanchor="sec16"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec16')}}">Trường hợp tránh sử dụng</a></li>
                    <li data-id="17" data-menuanchor="sec17"><a href="{{asset('edit/guidelines/'.$menu_id.'#sec17')}}">Phối cảnh logo</a></li>
                </ul>
            </li>
        </ul>
    ...
    <div id="fullpage" class="fullpage_admin">

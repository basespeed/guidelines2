                ...
                <div class="content">
                    ...
                    <div class="btn_front">
                        ...
                        <div class="button">
                            ...
                            <input type="file" data-id="{{$id1}}" data-menu="@php if(isset($id_menu_check)){echo $id_menu_check;} @endphp" name="section9_upload_font_th" class="upload_font_th section9_upload_font_th"/>
                        </div>
                        <div class="button">
                            <span>Upload font bổ trợ</span>
                            <input type="file" data-id="{{$id2}}" data-menu="@php if(isset($id_menu_check)){echo $id_menu_check;} @endphp" name="section9_upload_font_bt" class="upload_font_bt section9_upload_font_bt"/>
                        </div>
                        <div class="button">
                            <span>Upload font văn bản</span>
                            <input type="file" data-id="{{$id3}}" data-menu="@php if(isset($id_menu_check)){echo $id_menu_check;} @endphp" name="section9_upload_font_vb" class="upload_font_vb section9_upload_font_vb"/>
                        </div>
                    </div>
                </div>
            </div>

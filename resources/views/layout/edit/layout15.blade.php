<section  data-id="@php if(isset($id_menu_check)){echo $id_menu_check;} @endphp" class="section section15">
                                        ...
                                        <div class="insider">
                                            <div class="logo">
                                                <button class="btn_ground_logo border-hide active" type="button">
                                                    ...
                                                    <input type="file" data-id="{{$data->id_image}}" data-menu="@php if(isset($id_menu_check)){echo $id_menu_check;} @endphp" name="section15_upload_background1" class="upload_background section15_upload_background1" alt="logo"/>
                                        ...
                                        <div class="insider">
                                            <div class="logo">
                                                <button class="btn_ground_logo border-hide active" type="button">
                                                    ...
                                                    <input type="file" data-id="{{$data->id_image}}" data-menu="@php if(isset($id_menu_check)){echo $id_menu_check;} @endphp" name="section15_upload_background2" class="upload_background section15_upload_background2" alt="logo"/>
                                                    <i class="fa fa-times" aria-hidden="true"></i>
                                                </button>
                                            </div>
                                    ...
                                    <div class="item">
                                        <div class="insider">
                                            <div class="logo">
                                                <button class="btn_ground_logo border-hide active" type="button">
                                                    <img src="{{url('/').'/public'.$data->image_url}}" alt="icon" />
                                                    <input type="file" data-id="{{$data->id_image}}" data-menu="@php if(isset($id_menu_check)){echo $id_menu_check;} @endphp" name="section15_upload_background3" class="upload_background section15_upload_background3" alt="logo"/>
                                                    <i class="fa fa-times" aria-hidden="true"></i>
                                                </button>
                                            </div>
    ...
    <div class="alert_support">
        <div class="insider">
            ...
            <ul>
                <li><strong>Ảnh :</strong> 448 x 253</li>
            </ul>
        </div>
    </div>
</section>
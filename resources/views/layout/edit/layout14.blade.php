<section  data-id="@php if(isset($id_menu_check)){echo $id_menu_check;} @endphp" class="section section14">
    <input type="hidden" name="check_type_menu_layout14" class="check_type_menu_layout14" value="{{$check_menu}}">
    <div class="in">
                            ...
                            @if(!empty($data->image_url))
                                <div class="list">
                                    <button class="btn_ground_size border-hide" type="button">
                                        ...
                                        <input type="file" data-id="{{$data->id_image}}" data-menu="@php if(isset($id_menu_check)){echo $id_menu_check;} @endphp" name="section14_upload_background2" class="upload_background section14_upload_background2"/>
    ...
    <div class="alert_support">
        <div class="insider">
            <h3>Tương thích: </h3>
            <ul>
                <li><strong>Ảnh :</strong> 594 x 766</li>
            </ul>
        </div>
    </div>
</section>
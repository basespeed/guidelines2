<section  data-id="@php if(isset($id_menu_check)){echo $id_menu_check;} @endphp" class="section section16">
                    ...
                    @foreach($data_image as $data)
                        @if($data->image_type == 1 && $data->layout_image == 16 && $data->$check_menu == $id_menu_check)
                            <button class="btn_ground_logo border-hide active" type="button">
                                ...
                                <input type="file" data-id="{{$data->id_image}}" data-id="{{$data->id_image}}" data-menu="@php if(isset($id_menu_check)){echo $id_menu_check;} @endphp" name="section16_upload_background1" class="upload_background section16_upload_background1" alt="logo"/>
    ...
    <div class="alert_support">
        <div class="insider">
            ...
            <ul>
                <li><strong>Ảnh :</strong> 935 x 742</li>
            </ul>
        </div>
    </div>
</section>